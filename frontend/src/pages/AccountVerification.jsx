...
function AccountVerification() {
  ...
  return (
    <div className="flex h-[94svh] w-full items-center justify-center bg-[#f7f8fa] font-noto font-medium">
      <div className="flex flex-col m-4 items-center justify-center gap-y-4 rounded-lg bg-white p-8 drop-shadow-lg">
        <div className="mb-4 rounded-sm border text-center border-green-400 bg-green-200 px-3 py-1 text-lg font-semibold text-green-900">
        ...
        <div className="flex flex-col items-center text-sm">
          ...
          <div className="my-1">
            <Button color="iris"  onClick={() => console.log("Resend email")}>
              Resend email
            </Button>
          </div>
        </div>
