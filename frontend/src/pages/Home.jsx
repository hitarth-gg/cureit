...
function Home() {
  ...
  return (
    <div className="dotted h-[96svh] overflow-hidden font-noto">
      <div className="flex h-full animate-fade-up flex-col items-center justify-center py-32 md:justify-around lg:flex-row">
        <div className="flex flex-col items-center justify-center p-8">
          ...
          <div className="mt-12 flex w-full justify-center gap-x-4">
            <Button color="iris" size="3" variant="soft" className="my-4">
              Sign Up
            </Button>
        ...
        <div className="relative">
          <img
            src={docotorsImage}
            alt="doctors"
            className="h-52 object-cover md:h-72 lg:h-96"
          />
